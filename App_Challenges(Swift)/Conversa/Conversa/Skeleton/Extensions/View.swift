...
extension UIView {
    ...
    internal enum slideType: Int {
        case left = 0
        case right
    }
    
    func slideTo(type: slideType, duration: TimeInterval = 0.7) {
        let slideInFromLeftTransition = CATransition()
        slideInFromLeftTransition.type = CATransitionType.push
        slideInFromLeftTransition.subtype = type == .right ? CATransitionSubtype.fromRight : CATransitionSubtype.fromLeft
